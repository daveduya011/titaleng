...
class __TwigTemplate_bf0f859d673158a41e99c2649755f4559bf0673390cbec5bf37ff3f835781728 extends \Twig\Template
{
...
($context["overridden"] ?? null)) ? ("overridden") : (""))];
  ...
  ";
        ...
        if (($context["actions"] ?? null)) {
            // line 30
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["actions"] ?? null)), "html", null, true));
        }
        // line 32
        echo "  ";
...
";
    ...
    {
        return new Source("", "core/themes/stable/templates/admin/views-ui-display-tab-bucket.html.twig", "/var/www/html/titaleng/web/core/themes/stable/templates/admin/views-ui-display-tab-bucket.html.twig");
    }
}
