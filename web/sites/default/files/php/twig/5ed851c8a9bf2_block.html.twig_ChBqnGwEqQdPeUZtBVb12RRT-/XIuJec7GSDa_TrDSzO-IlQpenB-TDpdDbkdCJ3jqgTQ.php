...
class __TwigTemplate_f955b946d1b670b36a2eb00d47e7bb89a61c2ba8e2f148a44cf686efafd9ef5a extends \Twig\Template
{
...
($context["plugin_id"] ?? null)))), 3 => "clearfix"];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 59
            echo "    <h2";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["title_attributes"] ?? null), "addClass", [0 => "block-title"], "method")), "html", null, true));
            echo ">";
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/block/block.html.twig", "/var/www/html/titaleng/web/themes/contrib/bootstrap/templates/block/block.html.twig");
    }
}
