...
class __TwigTemplate_c45170599299202feab4ad9a85a5a8beb46c62ad61d6cc3097b9f4b24537d300 extends \Twig\Template
{
...
($context["status_classes"] ?? null), $context["type"], [], "array"))), 2 => "alert-dismissible"];
            ...
            // line 66
            echo "    <div";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "setAttribute", [0 => "class", 1 => ($context["classes"] ?? null)], "method"), "addClass", [0 => ($context["message_classes"] ?? null)], "method"), "setAttribute", [0 => "role", 1 => $this->getAttribute(($context["status_roles"] ?? null), $context["type"], [], "array")], "method"), "setAttribute", [0 => "aria-label", 1 => $this->getAttribute(($context["status_headings"] ?? null), $context["type"], [], "array")], "method")), "html", null, true));
            echo ">
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/system/status-messages.html.twig", "/var/www/html/titaleng/web/themes/contrib/bootstrap/templates/system/status-messages.html.twig");
    }
}
