...
class __TwigTemplate_63eb7d1f32c72c7f72d598e6f08900b8361a65b1034f639e2febf41a605f068d extends \Twig\Template
{
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null)))) : (""))];
    ...
    public function block_input($context, array $blocks = [])
    {
        ...
        if ((($context["icon"] ?? null) && ($context["icon_only"] ?? null))) {
            // line 35
            echo "      <button";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "icon-only"], "method")), "html", null, true));
            echo ">
        <span class=\"sr-only\">";
            // line 36
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/var/www/html/titaleng/web/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
}
