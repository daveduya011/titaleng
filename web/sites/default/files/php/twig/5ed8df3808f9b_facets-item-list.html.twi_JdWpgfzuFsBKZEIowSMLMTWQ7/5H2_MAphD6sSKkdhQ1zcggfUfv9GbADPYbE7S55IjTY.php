...
class __TwigTemplate_e3928570fba950059cb489eb9e398c9c37e890a40b23ba889cbc4cbfdbc9450e extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["facet"] ?? null), "widget", []), "type", [])), "html", null, true));
        echo "\">
  ";
        // line 28
        ...
        if ((($context["items"] ?? null) || ($context["empty"] ?? null))) {
            ...
            if (($context["items"] ?? null)) {
                // line 37
                echo "<";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["list_type"] ?? null)), "html", null, true));
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "value", [])), "html", null, true));
                    echo "</li>";
                }
...
";
        ...
        if (($this->getAttribute($this->getAttribute(($context["facet"] ?? null), "widget", []), "type", []) == "dropdown")) {
            ...
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["facet"] ?? null), "id", [])), "html", null, true));
            echo "_label\">Facet ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["facet"] ?? null), "label", [])), "html", null, true));
            echo "</label>";
        }
        // line 50
        echo "</div>
";
    ...
    {
        return new Source("", "modules/contrib/facets/templates/facets-item-list.html.twig", "/var/www/html/titaleng/web/modules/contrib/facets/templates/facets-item-list.html.twig");
    }
}
