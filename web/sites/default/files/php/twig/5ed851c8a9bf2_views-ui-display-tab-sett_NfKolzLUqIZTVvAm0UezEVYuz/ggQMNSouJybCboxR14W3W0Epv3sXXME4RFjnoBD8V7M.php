...
class __TwigTemplate_9fd936b88f55fb7e09a515fb1209051c0ce49d61b3f8ff3bb7a73106ab202955 extends \Twig\Template
{
...
($context["overridden"] ?? null)) ? ("overridden") : (""))];
  ...
  ";
        ...
        if (($context["settings_links"] ?? null)) {
            // line 33
            echo "    ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->safeJoin($this->env, $this->sandbox->ensureToStringAllowed(($context["settings_links"] ?? null)), "<span class=\"label\">&nbsp;|&nbsp;</span>")));
            echo "
  ";
        }
        // line 35
...
";
    ...
    {
        return new Source("", "core/themes/stable/templates/admin/views-ui-display-tab-setting.html.twig", "/var/www/html/titaleng/web/core/themes/stable/templates/admin/views-ui-display-tab-setting.html.twig");
    }
}
