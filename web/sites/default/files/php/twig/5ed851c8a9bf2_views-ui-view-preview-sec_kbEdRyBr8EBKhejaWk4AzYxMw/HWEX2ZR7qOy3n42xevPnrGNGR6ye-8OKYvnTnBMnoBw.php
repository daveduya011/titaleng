...
class __TwigTemplate_78a53883a8c1a4229f5ed2c70c2f98806f282c041ae995150a12fe62e7e4e55d extends \Twig\Template
{
...
";
        ...
        if (($context["links"] ?? null)) {
            ...
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["links"] ?? null)), "html", null, true));
            echo "</div>
";
        }
        // line 18
...
";
    ...
    {
        return new Source("", "core/themes/stable/templates/admin/views-ui-view-preview-section.html.twig", "/var/www/html/titaleng/web/core/themes/stable/templates/admin/views-ui-view-preview-section.html.twig");
    }
}
