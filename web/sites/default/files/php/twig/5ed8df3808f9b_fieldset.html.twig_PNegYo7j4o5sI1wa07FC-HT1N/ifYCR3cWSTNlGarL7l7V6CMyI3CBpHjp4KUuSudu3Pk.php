...
class __TwigTemplate_10c85ad3728ef4bcfc2642d80007826ada5201aa3ed09e9a611ef30ee57f7c21 extends \Twig\Template
{
...
($context["required"] ?? null)) ? ("form-required") : (""))];
        ...
        // line 40
        echo "  <legend";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["legend"] ?? null), "attributes", [])), "html", null, true));
        echo ">
    <span";
        // line 41
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["legend_span"] ?? null), "attributes", []), "addClass", [0 => ($context["legend_span_classes"] ?? null)], "method")), "html", null, true));
        echo ">";
  ...
  <div class=\"fieldset-wrapper\">
    ...
    ";
        ...
        if ($this->getAttribute(($context["description"] ?? null), "content", [])) {
            // line 57
            echo "      <div";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["description"] ?? null), "attributes", []), "addClass", [0 => "description"], "method")), "html", null, true));
            echo ">";
...
";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/form/fieldset.html.twig", "/var/www/html/titaleng/web/core/themes/seven/templates/classy/form/fieldset.html.twig");
    }
}
