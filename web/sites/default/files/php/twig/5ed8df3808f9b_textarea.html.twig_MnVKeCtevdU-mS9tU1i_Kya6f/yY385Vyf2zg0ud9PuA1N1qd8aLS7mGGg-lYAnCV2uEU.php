...
class __TwigTemplate_8a187680241f205604a655b46740a992fd1fbf17da831376be0f31bee4232b06 extends \Twig\Template
{
...
($context["required"] ?? null)) ? ("required") : (""))];
        // line 26
        echo "<div";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["wrapper_attributes"] ?? null), "addClass", [0 => "form-textarea-wrapper"], "method")), "html", null, true));
        echo ">
  <textarea";
        // line 27
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/textarea.html.twig", "/var/www/html/titaleng/web/themes/contrib/bootstrap/templates/input/textarea.html.twig");
    }
}
