...
class __TwigTemplate_b67943c635c806638345ff4e70337da23bb8176c831db7f3bef87c661b3084a1 extends \Twig\Template
{
  ...
  ";
        ...
        if ((($context["name"] ?? null) &&  !($context["page"] ?? null))) {
            ...
            echo "\">";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["name"] ?? null)), "html", null, true));
            echo "</a></h2>
  ";
        }
        // line 33
...
";
    ...
    {
        return new Source("", "core/modules/taxonomy/templates/taxonomy-term.html.twig", "/var/www/html/titaleng/web/core/modules/taxonomy/templates/taxonomy-term.html.twig");
    }
}
