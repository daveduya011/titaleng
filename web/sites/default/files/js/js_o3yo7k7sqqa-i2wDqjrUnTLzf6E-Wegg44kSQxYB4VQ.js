...
(function ($, Drupal, drupalSettings) {
  Drupal.color = {
    ...
    callback: function callback(context, settings, $form) {
      ...
      $colorPreview.find('.color-preview-header').css('background-color', $colorPalette.find('input[name="palette[light]"]').val());
      ...
      $colorPreview.find('.color-preview-sidebar .preview-block').css('background-color', $colorPalette.find('input[name="palette[lighter]"]').val());
